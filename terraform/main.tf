      ...
      Statement = [
        {
          ...
          Effect = "Allow"
          Resource = [
            "arn:aws:logs:eu-west-3:${local.account_id}:*/*",
            "arn:aws:dynamodb:eu-west-3:${local.account_id}:*/*"
          ]
        }
      ]
    })
      ...
      Statement = [
        {
          ...
          Effect = "Allow"
          Resource = [
            "arn:aws:ecs:eu-west-3:${local.account_id}:*/*",
            "arn:aws:cloudwatch:eu-west-3:${local.account_id}:*/*"
          ]
        }
      ]
    })
...
resource "aws_dynamodb_table" "arxiv_table" {
